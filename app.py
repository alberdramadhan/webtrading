...
def login():
    if request.method == 'POST':
        ...
        if is_valid:
            ...
            return render_template('login.html', message='Invalid credentials or expired', expiry_duration='Unknown')
    
    return render_template('login.html', expiry_duration='1 day')
